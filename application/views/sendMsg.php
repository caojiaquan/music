...
<?php include 'admin_header.php';?>
    <div id="OSC_Content">
        <div class="SpaceChannel">
            ...
            <div id="lnks">
                <strong><?php echo $loginUser->username;?>的博客</strong>
                <div>
                    <a href="welcome/person">TA的博客列表</a>&nbsp;|
        ...
        <div class="Blog">
            <div style="width: auto; height: auto; overflow: auto; position: relative;">
                <style>
                    ...
                    #AjaxBox form textarea {
                        background: #ffd;
                        border: 1px solid #ccc;
                        padding: 2px;
                    }

                    #AjaxBox form tr.submit td {
                        padding-top: 20px;
                    }
                    ...
                    #AjaxBox form table tr th {
                        text-align: right;
                    }

                    #AjaxBox form table tr td {
                        padding: 0 0 5px 0;
                    }

                    #AjaxBox form table tr td.heading {
                        font-weight: bold;
                        padding: 0;
                    }

                    #AjaxBox form table tr td span.Tip {
                        color: #F90;
                        margin-left: 10px;
                    }

                    #AjaxBox form table tr td span.Tip a {
                        margin: 0 5px;
                    }

                    #AjaxBox form table tr td input {
                        padding: 2px;
                    }

                    #AjaxBox form table tr td input.focusField {
                        background: #ffc;
                    }

                    #AjaxBox form table tr td textarea {
                        font-size: 10pt;
                        line-height: 20px;
                        padding: 2px;
                    }

                    #AjaxBox form table tr.submit td input {
                        font-size: 10pt;
                        padding: 2px 5px;
                    }

                    #AjaxBox img#img_vcode {
                    ...
                    #AjaxBox form tr.Tip td ol li.first {
                        font-weight: bold;
                        padding-left: 0px;
                        font-size: 10.5pt;
                    }

                    #AjaxBox form tr.Tip td ol li {
                        padding-left: 10px;
                    }
                ...
                <div id="AjaxBox">
                    ...
                    <div id="Content">
                        <div id="s_error_msg" class="error_msg"></div>
                        <div id="s_success_msg" class="success_msg"></div>
                        <form id="frm_sendmsg" action="message/save_sendMsg" method="POST">
                            <table>
                                <tbody>
                                <tr>
                                    <td class="heading">留言内容(最多250个字):</td>
                                </tr>
                                <tr>
                                    <td><textarea id="ta_msg_content" name="content"
                                                  style="width: 400px; height: 120px; padding: 2px; overflow: hidden;"></textarea>
                                    </td>
                                </tr>
                                <tr class="submit">
                                    <td>
