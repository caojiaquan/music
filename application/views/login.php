  ...
  <form id="frm_login" action="welcome/check_login" method="POST" style="float:left; width:620px;">
    ...
    <table>
    	<tbody><tr>
    		...
    		<td><input name="username" id="f_email" class="TEXT" style="width: 200px;" type="text"><span class="error"><?php echo isset($error_name)?$error_name:'';?></span></td>
    	</tr>
    	<tr>
    		<th>登录密码：</th>
    		<td><input name="password" id="f_pwd" class="TEXT" style="width: 200px;" type="password"><span class="error"><?php echo isset($error_pass)?$error_pass:'';?></span></td>
    	</tr>
    	<tr>
    		<th>&nbsp;</th>
